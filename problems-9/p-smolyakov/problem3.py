...
class _ExceptionLogEntry(_LogEntry):
    ...
    def __str__(self):
        return _LogEntry.__str__(self) + f'Raised {repr(self.exception)} occured'
...
class B(Loggable):
    def pro(self, arg, named = True):
        print('hallo', arg)
        # raise RuntimeError("dasf")
...
if __name__ == '__main__':
    ...
    print(str(a.log_storage()))
    print(str(b.log_storage()))
