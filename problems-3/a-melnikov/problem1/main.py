from typing import Self, TypeVar, Generic, Sequence
...
class Table(Generic[T]):
    ...
    def __init__(self, rows: int, columns: int, table: Sequence[Sequence[T | None]] | None = None):
        self.rows = rows
    ...
    def select_rows(self, *row_indices: int) -> Self:
        ...
        return type(self)(rows, self.columns, table)
    ...
    def select_columns(self, *column_indices: int) -> Self:
        ...
        return type(self)(self.rows, columns, table)
    ...
    def join_rows(self, table: Self) -> Self:
        ...
        return type(self)(rows, columns, res_table)
