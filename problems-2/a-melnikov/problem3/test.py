...
class TestListSortedDir(unittest.TestCase):
    ...
    def test_regular_dir(self):
        ...
        expected_errlog: str = "File 'symlink.txt' is not accessible. [Errno 2] No such file or directory: 'resources/regular_dir/symlink.txt'"
...
protected_file.txt 0"""
    ...
    def test_read_only_dir(self):
        ...
        self.errlog.seek(0)
        output_errlog: str = self.errlog.read().strip()
        expected_errlog: str = "File 'symlink.txt' is not accessible. [Errno 2] No such file or directory: 'resources/read_only_dir/symlink.txt'"
        self.assertEqual(expected_errlog, output_errlog)
